...
def VisualizeOne3D_13_GT(pts3D_person,co,ax,dataset_name, xlim, ylim, zlim):
    """
        this function visualizes one person in colorful 3D skeleton, with different colors
        represent different joints, the firsy input is 3 by 23 numpy array
        the second input is the color of skeleton
    ...
    """ 
    if dataset_name ==  'CMU':
        pts3D_person = np.array([pts3D_person[0,:],pts3D_person[2,:],-pts3D_person[1,:]]) 
...
def VisualizeAll3D_GT(pts3D,ax,dataset_name, xlim, ylim, zlim):
    """
    ...
    for counter in range (0,int(num_people)):
        ...
        pts3D_oneperson_13 = VisualizeOne3D_GT(pts3D_person,mild_orange_cv2 , ax,dataset_name, xlim, ylim, zlim)
        start_13 = counter * 13
        end_13 = start_13 + 13
        pts3D_13[0:3,start_13:end_13] = pts3D_oneperson_13[0:3]
    return pts3D_13

def VisualizeAll3D_13_GT(pts3D_for_13vis,ax,dataset_name, xlim, ylim, zlim):
    """
        this function visualizes all 3D skeletons from one image
        the form if pts3D is 4 by n numpy array, rows 0,1,2 are x,y,z, row3 is always 1
    """
    ...
    for counter in range (0,int(num_people)):
        ...
        pts3D_person = pts3D[0:3,start:end]
        pts3D_oneperson_13 = VisualizeOne3D_13_GT(pts3D_person,mild_orange_cv2 , ax,dataset_name, xlim, ylim, zlim)
    pts3D_13 = np.zeros((4,int(13 * num_people)))
    return pts3D_13